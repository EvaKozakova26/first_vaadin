...
public class MainLayout extends Div
    ...
    public MainLayout() {
        ...
        reviews.add(new Icon(VaadinIcon.LIST), new com.vaadin.flow.component.Text("Reviews"));
        ...
        categories.add(new Icon(VaadinIcon.ARCHIVES), new com.vaadin.flow.component.Text("Categories"));
